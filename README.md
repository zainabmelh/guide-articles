...
This repo is where we plan and maintain these guide articles, which we then host on our community's wiki-like [guides website](guide.netlify.com/docs).
...
Guide articles can be an explanation of a syntax, design pattern, what aria labels are for, or something like what the numbers mean in the top right hand corner of your screen when at freecodecamp.org. You can find an [example article about HTML Elements here](./articles/HTML/Elements/index.md).
...
To help, find a `stub article` on our [guides website](guide.netlify.com/docs), write the article, then open a pull request to replace the stub with your article.
...
- Add a remote upstream so git knows where the official freeCodeCamp guide-articles repository is located with the command `git remote add upstream https://github.com/freeCodeCamp/guide-articles.git`
